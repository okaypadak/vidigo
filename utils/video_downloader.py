...
def _download_instaloader_post(loader, post, output_dir, target):
    ...
    return _find_latest_video_file(output_dir, stem=expected_stem, ignore_paths=existing_files) or _find_latest_video_file(
        output_dir,
        stem=expected_stem,
    )
...
def download_instagram_video(url, save_path="downloads", cookie_path=None):
    ...
    return _instagram_item_from_post(post, video_path)
