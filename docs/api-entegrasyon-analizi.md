...
| Platform | Giriş yöntemi | API biçimi | Webhook çeşidi | Kargo rolü | Resmi API dokümanı | Temel yetenekler | İlk geliştirmedeki özel ihtiyaç |
|---|---|---|---|---|---|---|---|
...
| Kargo firması | Giriş yöntemi | API biçimi | Webhook çeşidi | Resmi API dokümanı | Everup'taki temel kullanım |
|---|---|---|---|---|---|
